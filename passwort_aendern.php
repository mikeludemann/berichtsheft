...
if($_SESSION['rolle'] > 1){
    header("Location: passwort_aendern_beobachter.php?was=status");
    echo' <script type="text/javascript">
      function weiterleiten()
      {
      self.location.href="passwort_aendern_beobachter.php?was=status";
      }
      window.setTimeout("weiterleiten()",0);
  </script>';
  die();
 ...
 if ( false===($errors=validateInput()) ) {
     ...
     if (1!=mysql_affected_rows())
     {
         ...
         echo '<script type="text/javascript">
            function weiterleiten()
            {
            self.location.href="Mein_Konto.php?was=status";
            }
            window.setTimeout("weiterleiten()",500);
         </script>';
         echo '<div class="abstand_content"><br/>Passwort wurde geändert<br/><br/></div>';
     }
 }
        ...
        <h1>Passwort ändern</h1>
         <form method="POST" action="?was=status">
             ...
             <div class="abstand_11">
                ...
                <a href="Mein_Konto.php?was=status">
